...
import com.springboot.angular.domain.Task;
import com.springboot.angular.repository.TaskRepository;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().taskId(DEFAULT_TASK_ID).title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().taskId(UPDATED_TASK_ID).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return task;
    }
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.taskId(UPDATED_TASK_ID).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.taskId(UPDATED_TASK_ID).title(UPDATED_TITLE);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.taskId(UPDATED_TASK_ID).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
