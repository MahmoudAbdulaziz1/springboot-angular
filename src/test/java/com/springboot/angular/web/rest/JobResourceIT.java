...
import com.springboot.angular.domain.Job;
import com.springboot.angular.repository.JobRepository;
...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().jobId(DEFAULT_JOB_ID).jobTitle(DEFAULT_JOB_TITLE).minSalary(DEFAULT_MIN_SALARY).maxSalary(DEFAULT_MAX_SALARY);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().jobId(UPDATED_JOB_ID).jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY);
        return job;
    }
    ...
    void putNewJob() throws Exception {
        ...
        updatedJob.jobId(UPDATED_JOB_ID).jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY);
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.jobId(UPDATED_JOB_ID).jobTitle(UPDATED_JOB_TITLE);
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.jobId(UPDATED_JOB_ID).jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY);
