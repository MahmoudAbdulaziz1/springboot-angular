...
import com.springboot.angular.domain.Location;
import com.springboot.angular.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getAddressId()).isEqualTo(DEFAULT_ADDRESS_ID);
    ...
    void putNewLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getAddressId()).isEqualTo(UPDATED_ADDRESS_ID);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.addressId(UPDATED_ADDRESS_ID).postalCode(UPDATED_POSTAL_CODE).stateProvince(UPDATED_STATE_PROVINCE);
