package com.springboot.angular.web.rest;
...
import com.springboot.angular.IntegrationTest;
import com.springboot.angular.domain.Region;
import com.springboot.angular.repository.RegionRepository;
...
class RegionResourceIT {
    ...
    private static final Long DEFAULT_REGOIN_ID = 1L;
    private static final Long UPDATED_REGOIN_ID = 2L;
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().regoinId(DEFAULT_REGOIN_ID).regionName(DEFAULT_REGION_NAME);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().regoinId(UPDATED_REGOIN_ID).regionName(UPDATED_REGION_NAME);
        return region;
    }
    ...
    void createRegion() throws Exception {
        ...
        assertThat(testRegion.getRegoinId()).isEqualTo(DEFAULT_REGOIN_ID);
    ...
    void getAllRegions() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.[*].regoinId").value(hasItem(DEFAULT_REGOIN_ID.intValue())))
    ...
    void getRegion() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.regoinId").value(DEFAULT_REGOIN_ID.intValue()))
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.regoinId(UPDATED_REGOIN_ID).regionName(UPDATED_REGION_NAME);
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getRegoinId()).isEqualTo(UPDATED_REGOIN_ID);
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.regoinId(UPDATED_REGOIN_ID).regionName(UPDATED_REGION_NAME);
